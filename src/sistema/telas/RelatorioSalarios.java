...
public class RelatorioSalarios extends JPanel{
    ...
    private void criarComponentes(){
        ...
        labelDescricao = new JLabel("Esse gr�fico representa a quantidade de funcion�rios por faixas salariais.", JLabel.CENTER);
        
        CategoryDataset dadosGrafico = this.criarDadosGrafico();
        
        JFreeChart someChart = ChartFactory.createBarChart("", null, "Quantidade de funcion�rios", dadosGrafico, PlotOrientation.VERTICAL, true, true, false);
     ...
     private CategoryDataset criarDadosGrafico(){
         ...
         try{
             ...
             while(resultados.next()){
                 dados.addValue(resultados.getInt("faixa1"), "At� R$ 1.000", "< R$1.000 ");
                 dados.addValue(resultados.getInt("faixa2"), "De R$ 1.000 at� R$ 2.000", "< R$1.000 ");
                 dados.addValue(resultados.getInt("faixa3"), "De R$ 2.000 at� R$ 3.000", "< R$2.000 ");
                 dados.addValue(resultados.getInt("faixa4"), "De R$ 3.000 at� R$ 4.000", "< R$3.000 ");
                 dados.addValue(resultados.getInt("faixa5"), "De R$ 4.000 at� R$ 5.000", "< R$4.000 ");
