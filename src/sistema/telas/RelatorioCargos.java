...
public class RelatorioCargos extends JPanel{
    ...
    private void criarComponentes(){
        ...
        labelDescricao = new JLabel("Esse gr�fico representa a quantidade de funcionarios por cargos", JLabel.CENTER);
    ...
    private DefaultPieDataset criarDadosGrafico(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Ocorreu um erro ao criar relat�rio. \n\n"+ex.getMessage());
            Navegador.inicio();
        }
